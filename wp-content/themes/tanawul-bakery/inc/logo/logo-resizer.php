...
function tanawul_bakery_customize_controls_js() {
	wp_enqueue_script( 'tanawul-bakery-customizer-controls', get_template_directory_uri() . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
